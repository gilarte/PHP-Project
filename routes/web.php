...
Route::get('/dashboard', function () {
    ...
    $accounts2 = Account::all();
    $sumaccounts = $accounts->sum('balance');
    $sumaccounts2 = $accounts2->sum('balance');
    return view('dashboard', ['sumaccounts' => $sumaccounts], ['sumaccounts2' => $sumaccounts2]);
