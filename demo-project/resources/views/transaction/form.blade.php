...
<div class="box box-info padding-1" style="background-color: #1f2937; height: 600px; width: 85%; margin-left: 8%; border-radius: 20px">
    <div class="box-body">
        ...
        <div class="form-group" style="width:25%; margin-left: 500px; color: white;">
            ...
            {{ Form::select('AccountNumber', $accounts ? $accounts->pluck('AccountNumber', 'AccountNumber') : [], null, ['class' => 'form-control' . ($errors->has('AccountNumber') ? ' is-invalid' : ''), 'placeholder' => 'Select account', 'required', 'onchange' => 'validarNumeros()']) }}
        ...
        <div class="form-group" style="width:25%; margin-left: 500px; color: white">
            {{ Form::label('type') }}
            {{ Form::select('type', ['' => 'Select transaction type', 'Add' => 'Add', 'Send' => 'Send'], $transaction->type ?? null, ['class' => 'form-control' . ($errors->has('type') ? ' is-invalid' : ''), 'required']) }}
